  ...
  <div class="wrapper">
    <div class="container">
      ...
      <div class="row">
        ...
        <!-- main -->
        <form class="" action="/berita/{{$b->id}}/update" method="post" enctype="multipart/form-data">

          {{csrf_field ()}}

          <div class="row">
              <div class="col-xl-6">
                <input type="hidden" name="thumbnail1" value="{{$b->thumbnail}}">
                <img src="/image/{{$b->thumbnail}}" alt="thumbnail"  class="m-t-30"  width="100%" data-height="300" />
              </div>
          ...
          <fieldset class="form-group">
              ...
              <textarea class="form-control" id="exampleTextarea2" name="content"
                        rows="3">{{ $b->content}}</textarea>
          ...
          <fieldset class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInput" name="author" value="{{ $b->author }}"
            ...
            <button type="submit" class="btn btn-warning waves-effect waves-light btn-sm">Update</button>
